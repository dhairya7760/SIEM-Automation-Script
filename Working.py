...
def connect_to_splunk(username,password,host='localhost',port='8000',owner='admin',app='search',sharing='user'):
    try:
        service = "asd"
...
def main():
    try:
        splunk_service = connect_to_splunk(username='Darsh',password='p@ssw0rd')
